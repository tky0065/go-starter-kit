...
func TestE2ESQLiteProjectGeneration(t *testing.T) {
	...
	t.Run("AC1_GenerateWithSQLite", func(t *testing.T) {
		...
		if err := generateProjectFiles(projectPath, projectName, DefaultTemplate, "sqlite", DefaultObservabilityLevel, DefaultFramework); err != nil {
...
func TestE2ESQLiteVsPostgresComparison(t *testing.T) {
	...
	if err := generateProjectFiles(sqliteProjectPath, "sqlite-project", DefaultTemplate, "sqlite", DefaultObservabilityLevel, DefaultFramework); err != nil {
	...
	if err := generateProjectFiles(postgresProjectPath, "postgres-project", DefaultTemplate, "postgres", DefaultObservabilityLevel, DefaultFramework); err != nil {
