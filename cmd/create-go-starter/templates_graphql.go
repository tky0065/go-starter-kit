...
// GraphQLEmailHelpersTemplate returns email validation helpers for GraphQL resolvers.
func (t *ProjectTemplates) GraphQLEmailHelpersTemplate() string {
	return `package graph
...
Le code GraphQL généré est déjà inclus. Régénérez-le uniquement après modification du schéma.
...
# ============================================================================
# STEP 3: Prepare GraphQL Runtime
# ============================================================================
print_step "Étape 3/5: Préparation GraphQL"

print_success "Le code GraphQL généré est déjà inclus dans le projet"
print_info "Utilisez 'go generate ./...' uniquement après modification du schéma"
...
echo "  2. GraphQL Playground:       http://localhost:8080/"
echo "  3. Endpoint GraphQL:         http://localhost:8080/query"
echo "  4. Régénérer si besoin:      go generate ./..."
echo ""
...
func (t *ProjectTemplates) GraphQLGenerateGoTemplate() string {
	return `//go:generate go run github.com/99designs/gqlgen@v0.17.73 generate
