...
func TestE2EMySQLVsPostgresComparison(t *testing.T) {
	...
	if err := generateProjectFiles(mysqlPath, mysqlProjectName, template, "mysql"); err != nil {
	...
	if err := generateProjectFiles(pgPath, pgProjectName, template, "postgres"); err != nil {
